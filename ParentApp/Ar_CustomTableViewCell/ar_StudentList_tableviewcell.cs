...
namespace ParentApp
{
	public partial class ar_StudentList_tableviewcell : UITableViewCell
	{
		public static readonly NSString Key = new NSString("ar_StudentList_tableviewcell");
		public static readonly UINib Nib;
		public static event EventHandler ViewDetailsClicked = delegate { };
		public static event EventHandler CarClicked = delegate { };

		static ar_StudentList_tableviewcell()
		{
			Nib = UINib.FromName("ar_StudentList_tableviewcell", NSBundle.MainBundle);
		}

		protected ar_StudentList_tableviewcell(IntPtr handle) : base(handle)
		{
			// Note: this .ctor should not contain any initialization logic.
		}
		public static ar_StudentList_tableviewcell Create()
		{
			return (ar_StudentList_tableviewcell)Nib.Instantiate(null, null)[0];
		}
