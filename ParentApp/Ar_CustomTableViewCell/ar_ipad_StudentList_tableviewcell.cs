...
namespace ParentApp
{
	public partial class ar_ipad_StudentList_tableviewcell : UITableViewCell
	{
		public static readonly NSString Key = new NSString("ar_ipad_StudentList_tableviewcell");
		public static readonly UINib Nib;
		public static event EventHandler ViewDetailsClicked = delegate { };
		public static event EventHandler CarClicked = delegate { };

		static ar_ipad_StudentList_tableviewcell()
		{
			Nib = UINib.FromName("ar_ipad_StudentList_tableviewcell", NSBundle.MainBundle);
		}

		protected ar_ipad_StudentList_tableviewcell(IntPtr handle) : base(handle)
		{
			// Note: this .ctor should not contain any initialization logic.
		}
		public static ar_ipad_StudentList_tableviewcell Create()
		{
			return (ar_ipad_StudentList_tableviewcell)Nib.Instantiate(null, null)[0];
		}
		public void UpdateCell(int index, string student_id, string s_route_id, string student_name, string profilePic, string blink_status, string drivername, string drivercontact)
		{
			try
			{
				...
				imgCar.TouchUpInside += (object sender, EventArgs e) =>
				 {
